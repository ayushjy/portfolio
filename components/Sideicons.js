...
const Sideicons = ({isSideiconpresent}) => {
  ...
  return (
    ...
    <div className='flex flex-col fixed bottom-0 right-0 gap-3 pr-12 max-lg:pr-6 max-md:pr-4 pb-12'>
       ...
       <Link target='blank' href={""}> <div className='text-white hover:text-blue-400 cursor-pointer hover:-translate-y-2 transition ease-out hover:animate-bounce'><FaTwitter size={30}  /></div></Link>
