    ...
    return (
        <div className='py-14 px-56 max-2xl:px-48 max-lg:px-20 max-md:px-8 flex flex-col'>
            ...
            <div className='w-11/12 flex flex-col justify-center pt-8'>
                ...
                <div className='text-gray-400 text-2xl max-lg:text-xl font1 pb-5'>I am a Full-Stack creative developer based in Barielly, India. I am a Computer Science undergraduate from Chandigarh University and also did some coursework in Designing and Visual Arts.</div>
