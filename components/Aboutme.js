    ...
    const data = [
...

        {
            ...
            achieve_details: [
                {
                    id: 1,
                    title: 'Hashnode Hackathon Winner',
                    title_head: 'Top 5 among 2134 participants | JUN 2022',
                    desc1: 'Developed Metrack, a web application that provides users with hand-picked YouTube courses, real-time discussions, sharing projects, and getting feedback on them, resulting in a win at the Hashnode Hackathon and recognition in the tech community.',
                    desc2: 'The project currently has 50+ registered users and has been praised for its innovative approach to online learning.',
                },
                {
                id: 2,
                title: 'LinkedIn',
                title_head: '9200+ Followers',
                desc1: 'Grew LinkedIn following to 8200+ followers through consistent and engaging content creation, establishing myself as a thought leader in the software development community and building a strong professional network.'         
            }
           ]
        },


        { id: 5, name: 'Resume', description: 'Description for Item 2' },
    ];
